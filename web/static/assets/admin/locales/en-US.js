...
window.XBOARD_TRANSLATIONS['en-US'] = {
  ...
  "settings": {
    ...
    "description": "Manage the site, admin path, and node communication settings used by Airboard.",
    "server": {
      "title": "Server Configuration",
      "description": "Configure the communication token used by nodes to dock with the panel.",
      "server_token": {
    ...
    "site": {
      "title": "Site Settings",
      "description": "Configure the basic site information used by the panel and subscription links.",
      "form": {
        "siteName": {
          "label": "Site Name",
    ...
    "safe": {
      ...
      "description": "Configure the basic security options currently used by the panel.",
      "form": {
        "emailVerify": {
